...
export declare function isLabel<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.label.defs", "label">;
...
export declare function isSelfLabels<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.label.defs", "selfLabels">;
...
export declare function isSelfLabel<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.label.defs", "selfLabel">;
...
export declare function isLabelValueDefinition<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.label.defs", "labelValueDefinition">;
...
export declare function isLabelValueDefinitionStrings<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.label.defs", "labelValueDefinitionStrings">;
