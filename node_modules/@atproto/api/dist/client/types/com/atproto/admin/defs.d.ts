...
export declare function isStatusAttr<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.admin.defs", "statusAttr">;
...
export declare function isAccountView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.admin.defs", "accountView">;
export declare function validateAccountView<V>(v: V): ValidationResult<AccountView & V>;
export interface RepoRef {
    $type?: 'com.atproto.admin.defs#repoRef';
    did: string;
}
export declare function isRepoRef<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.admin.defs", "repoRef">;
...
export declare function isRepoBlobRef<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.admin.defs", "repoBlobRef">;
...
export declare function isThreatSignature<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.admin.defs", "threatSignature">;
