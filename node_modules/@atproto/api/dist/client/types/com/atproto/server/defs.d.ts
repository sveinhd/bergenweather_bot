...
export declare function isInviteCode<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.server.defs", "inviteCode">;
...
export declare function isInviteCodeUse<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.server.defs", "inviteCodeUse">;
