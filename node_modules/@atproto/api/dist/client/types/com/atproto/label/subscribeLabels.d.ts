...
export declare function isLabels<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.label.subscribeLabels", "labels">;
...
export declare function isInfo<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.label.subscribeLabels", "info">;
