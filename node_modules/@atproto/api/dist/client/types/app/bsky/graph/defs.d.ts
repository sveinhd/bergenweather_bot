...
export declare function isListViewBasic<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "listViewBasic">;
...
export declare function isListView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "listView">;
...
export declare function isListItemView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "listItemView">;
...
export declare function isStarterPackView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "starterPackView">;
...
export declare function isStarterPackViewBasic<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "starterPackViewBasic">;
...
export declare function isListViewerState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "listViewerState">;
...
export declare function isNotFoundActor<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "notFoundActor">;
...
export declare function isRelationship<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.defs", "relationship">;
