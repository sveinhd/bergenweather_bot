...
export declare function isMain<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.record", "main">;
...
export declare function isView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.record", "view">;
...
export interface ViewRecord {
    ...
    likeCount?: number;
    quoteCount?: number;
    embeds?: ($Typed<AppBskyEmbedImages.View> | $Typed<AppBskyEmbedVideo.View> | $Typed<AppBskyEmbedGallery.View> | $Typed<AppBskyEmbedExternal.View> | $Typed<View> | $Typed<AppBskyEmbedRecordWithMedia.View> | {
        $type: string;
    })[];
    indexedAt: string;
}
export declare function isViewRecord<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.record", "viewRecord">;
...
export declare function isViewNotFound<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.record", "viewNotFound">;
...
export declare function isViewBlocked<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.record", "viewBlocked">;
...
export declare function isViewDetached<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.record", "viewDetached">;
