...
export interface PostView {
    ...
    embed?: $Typed<AppBskyEmbedImages.View> | $Typed<AppBskyEmbedVideo.View> | $Typed<AppBskyEmbedGallery.View> | $Typed<AppBskyEmbedExternal.View> | $Typed<AppBskyEmbedRecord.View> | $Typed<AppBskyEmbedRecordWithMedia.View> | {
        $type: string;
    };
...
export declare function isPostView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "postView">;
...
export declare function isViewerState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "viewerState">;
...
export declare function isThreadContext<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "threadContext">;
...
export declare function isFeedViewPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "feedViewPost">;
...
export declare function isReplyRef<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "replyRef">;
...
export declare function isReasonRepost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "reasonRepost">;
export declare function validateReasonRepost<V>(v: V): ValidationResult<ReasonRepost & V>;
export interface ReasonPin {
    $type?: 'app.bsky.feed.defs#reasonPin';
}
export declare function isReasonPin<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "reasonPin">;
...
export declare function isThreadViewPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "threadViewPost">;
...
export declare function isNotFoundPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "notFoundPost">;
...
export declare function isBlockedPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "blockedPost">;
...
export declare function isBlockedAuthor<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "blockedAuthor">;
...
export declare function isGeneratorView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "generatorView">;
...
export declare function isGeneratorViewerState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "generatorViewerState">;
...
export declare function isSkeletonFeedPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "skeletonFeedPost">;
...
export declare function isSkeletonReasonRepost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "skeletonReasonRepost">;
...
export declare function isSkeletonReasonPin<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "skeletonReasonPin">;
...
export declare function isThreadgateView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "threadgateView">;
...
export declare function isInteraction<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.defs", "interaction">;
